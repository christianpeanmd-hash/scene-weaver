...
interface SetupStepProps {
  ...
  expandedChar: number | string | null;
  setExpandedChar: (value: number | string | null) => void;
  expandedEnv: number | string | null;
  setExpandedEnv: (value: number | string | null) => void;
  onAddCharacter: () => void;
  ...
  onUpdateCharacter: (id: number | string, field: keyof Character, value: string) => void;
  onRemoveCharacter: (id: number | string) => void;
  ...
  onUpdateEnvironment: (id: number | string, field: keyof Environment, value: string) => void;
  onRemoveEnvironment: (id: number | string) => void;
  onGenerate: () => void;
