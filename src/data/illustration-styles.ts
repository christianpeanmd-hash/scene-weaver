...
export const ILLUSTRATION_STYLES: IllustrationStyle[] = [
  ...
  },
  {
    ...
    category: "artistic",
    look: "Traditional oil painting style, rich colors, formal composition, Renaissance influences",
    feel: "Timeless, dignified, masterful craftsmanship",
    useCase: "Profile pieces, leadership portraits, prestigious content",
    promptTemplate: "Classical portrait painting style, rich oil colors, dramatic chiaroscuro lighting, Renaissance master composition, formal and dignified. {subject}",
    previewPrompt: "Classical oil portrait, Renaissance style, rich colors, dramatic lighting, formal composition",
  },
  {
    id: "stick-figure",
    name: "Stick Figure",
    category: "humor",
    look: "Simple stick figures with minimal detail, clean white background, basic shapes",
    feel: "Charming, universally relatable, ideas over aesthetics",
    useCase: "Quick explanations, universal concepts, humorous takes",
    promptTemplate: "Simple stick figure illustration, minimal black lines on white, basic human forms with expressive poses, charming simplicity. {subject}",
    previewPrompt: "Stick figure illustration, simple black lines, white background, expressive minimal characters",
  },
  {
    id: "impressionist",
    name: "Impressionist",
    category: "artistic",
    look: "Soft brushstrokes, dappled light effects, Monet-inspired color blending",
    feel: "Dreamy, atmospheric, captures fleeting moments",
    useCase: "Emotional narratives, nature themes, artistic storytelling",
    promptTemplate: "Impressionist painting style inspired by Monet, soft visible brushstrokes, dappled light, pastel and vibrant colors blending. {subject}",
    previewPrompt: "Impressionist portrait, Monet style, soft brushstrokes, dappled light, pastel colors",
  },
  {
    id: "digital-futurism",
    name: "Digital Futurism",
    category: "futurism",
    look: "Holographic elements, data visualizations, sleek interfaces, AR/VR aesthetic",
    feel: "Cutting-edge, innovative, tomorrow's world today",
    useCase: "Tech predictions, AI/ML content, innovation themes",
    promptTemplate: "Digital futurism illustration, holographic overlays, floating data streams, sleek UI elements, AR aesthetic, cutting-edge technology feel. {subject}",
    previewPrompt: "Digital futurism portrait, holographic elements, floating data, sleek AR interface, innovative",
  },
  {
    id: "editorial-gravitas",
    name: "Editorial Gravitas",
    category: "editorial",
    look: "Bold compositions, dramatic shadows, limited palette, New Yorker magazine style",
    feel: "Authoritative, sophisticated, intellectually serious",
    useCase: "Opinion pieces, analysis, heavyweight journalism",
    promptTemplate: "Editorial illustration with gravitas, bold composition, dramatic shadows, limited sophisticated palette, New Yorker magazine aesthetic. {subject}",
    previewPrompt: "Editorial gravitas portrait, bold composition, dramatic shadows, limited palette, sophisticated",
  },
  {
    id: "strategy-diagram",
    name: "Strategy Diagram",
    category: "explainer",
    look: "Clean flowcharts, connected nodes, business framework aesthetic, consulting deck style",
    feel: "Strategic, organized, executive-ready clarity",
    useCase: "Business strategy, frameworks, executive presentations",
    promptTemplate: "Strategy diagram illustration, clean connected nodes, business framework aesthetic, McKinsey-style clarity, organized visual hierarchy. {subject}",
    previewPrompt: "Strategy diagram style, clean nodes and connections, business framework, executive aesthetic",
  },
  {
    id: "dark-humor",
    name: "Dark Humor",
    category: "humor",
    look: "Muted colors, slightly unsettling compositions, Edward Gorey inspired",
    feel: "Macabre wit, sophisticated darkness, wry commentary",
    useCase: "Ironic takes, gallows humor, unconventional perspectives",
    promptTemplate: "Dark humor illustration inspired by Edward Gorey, muted palette, slightly unsettling composition, macabre wit with sophisticated linework. {subject}",
    previewPrompt: "Dark humor portrait, Edward Gorey style, muted colors, macabre wit, sophisticated linework",
  },
];
